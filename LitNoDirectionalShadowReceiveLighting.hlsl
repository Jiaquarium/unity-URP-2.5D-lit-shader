...
// Adjusted to ignore Directional Light shadows.
...
#endif
    light.shadowAttenuation = AdditionalLightShadow(perObjectLightIndex, light.direction, positionWS, shadowMask, occlusionProbeChannels);
