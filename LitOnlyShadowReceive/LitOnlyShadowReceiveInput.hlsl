...
UNITY_DOTS_INSTANCING_START(MaterialPropertyMetadata)
    ...
    UNITY_DOTS_INSTANCED_PROP(float4, _ClippedColor)
    UNITY_DOTS_INSTANCED_PROP(float4, _ShadowAdjustment)
...
#define _ClippedColor           UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(float  , Metadata__ClippedColor)
#define _ShadowAdjustment       UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(float  , Metadata__ShadowAdjustment)
#endif
